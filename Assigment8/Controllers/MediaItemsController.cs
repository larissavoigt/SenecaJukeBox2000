...
namespace Assigment8.Controllers
{
    public class MediaItemsController : Controller
    {
        ...
        // GET: MediaItem/5
        // Attention - 12 - Dedicated media item delivery method, uses attribute routing
        ...
        public ActionResult Details(string stringId = "")
        {
            ...
            else
            {
                ...
                // Set the Content-Type header, and return the media item bytes
                return File(o.Content, o.ContentType);
            }
        }

        // GET: MediaItem/5/Download
        // Attention - 13 - Dedicated media item DOWNLOAD method, uses attribute routing
